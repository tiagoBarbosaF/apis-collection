...
public interface ProductApi {
    ...
    @Operation(summary = "Create products by file", description = "Creates a list of products using file and returns " +
                                                                  "the create product message.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Product created successfully",
                    content = @Content(mediaType = "application/json",
    ...
    ResponseEntity<MessageResponse> createListProductsByFile(@RequestParam("file") MultipartFile file);
}
